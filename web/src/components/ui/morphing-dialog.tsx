...
function MorphingDialogContent({
  ...
  //@ts-expect-error - TS7016: Could not find a declaration file for module 'usehooks-ts'.
      ...
      {isOpen && (
        <>
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-white/40 backdrop-blur-sm dark:bg-black/40"
          />
